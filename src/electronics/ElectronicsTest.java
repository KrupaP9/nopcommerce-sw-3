...
public class ElectronicsTest extends UtilitiesNopCommerce {
    @Before
    public void setUp() {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        //get actual
        String actualNokiaPrice = getTextFromElement(By.xpath("//body[1]/div[6]/div[3]/div[1]/div[2]/div[1]/div[1]/form[1]/div[2]/div[1]/div[2]/div[6]/div[1]/span[1]"));
        ...
        Thread.sleep(1000);
        //Enter First Name
        sendTextToElement(By.id("FirstName"),"Krupa");
        //Enter Last Name
        sendTextToElement(By.id("LastName"),"Pandya");
        //Enter Date
        ...
        //Enter Email
        sendTextToElement(By.id("Email"),"pandyakrupaatesting@gmail.com");
        //Enter Password
        ...
        Thread.sleep(1000);
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "Naple");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"), "20 London Road");
        Thread.sleep(1000);
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Mr ABCD XYZ");
